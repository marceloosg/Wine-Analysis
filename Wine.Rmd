...
mwine=mwine[variable!="quality"]
mwine$quality=q
z=mwine[,.(m=mean(value)),.(variable,type,quality)]
ggplot(z[order(quality,type,variable)][variable=='density'],aes(m,y=quality,color=type))+geom_smooth(span=0.6,se=T)+geom_point()
```